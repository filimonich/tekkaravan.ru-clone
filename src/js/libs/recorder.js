...
let voiceModal = getElement('.voice-message-modal');
let voicePreview = getElement('.voice-message-modal .voice-preview audio');
let voiceStop = getElement('.voice-message-modal .stop-rec');
let voiceSend = getElement('.voice-message-modal .send-rec');
let voiceCancel = getElement('.voice-message-modal .cancel-rec');
